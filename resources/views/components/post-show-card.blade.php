...
<div class="post-show-card">
    ...
    <div class="link-back">
        <a class="back" href="{{ route('index') }}">@lang('messages.back')</a>
    </div>
    ...
    <article class="post-article">
        <div class="home_post">
            ...
            <div class="home_post-details">
                <div class="category">
                    <p>
                        <a href="{{ route('index') . '?category=' . $post->category->slug . '&' . http_build_query(request()->except('category', 'page')) }}">
                        {{ $post->category->name }}
                        </a>
                    </p>
                </div>
                ...
                <div class="author-post-link">
                    ...
                    <div class="author-name">
                        <a href="{{ route('index') . '?author=' . $post->author->username . '&' . http_build_query(request()->except('category', 'page')) }}">
                            {{ $post->author->name }}
                        </a> 
                    </div>
